...
[Migration("20240104224307_EmployeeUserbaseUserType")]
partial class EmployeeUserbaseUserType {
  /// <inheritdoc />
...
#pragma warning disable 612, 618
    ...
    modelBuilder.Entity("webapi.Models.Accounts.Employee", b => {
      b.HasBaseType("webapi.Models.Accounts.UserBase");

      b.Property<int>("BirthYear").HasColumnType("int");

      b.Property<int>("EmployeeType").HasColumnType("int");
    ...
    modelBuilder.Entity("webapi.Models.Accounts.Employee", b => {
      b.HasOne("webapi.Models.Accounts.UserBase", null)
          .WithOne()
          .HasForeignKey("webapi.Models.Accounts.Employee", "Id")
          .OnDelete(DeleteBehavior.Cascade)
          .IsRequired();
    });
