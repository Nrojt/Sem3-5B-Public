      ...
      <section className="position-relative py-4 py-xl-5">
        <Container className="container position-relative">
          ...
          <Row className="row d-flex justify-content-center">
            <Col md={6} xl={4} lg={4}>
              <Col className="d-flex flex-column justify-content-center align-items-start h-100">
                <div className="d-flex align-items-center p-3">
                  ...
                  <div className="px-2">
                    <h2 className="mb-0">{t("phone_number")}</h2>
                    <p className="mb-0 text-wrap">+310302398270</p>
                  </div>
                </div>
                <div className="d-flex align-items-center p-3">
                  <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                  ...
                  <div className="px-2">
                    ...
                    <p className="mb-0 text-wrap">info@accessibility.nl</p>
                  </div>
                </div>
                <div className="d-flex align-items-center p-3">
                  <div className="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                  ...
                  <div className="px-2">
                    <h2 className="mb-0">{t("location")}</h2>
